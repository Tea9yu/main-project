					...
					<div className="flex items-center">
						...
						<div className="items-center justify-between w-full" id="mobile-menu-2">
							<ul className="flex flex-row font-medium space-x-4">
								...
								<li>
									<Link to='/upload'
										className="block py-2 pl-3 pr-4 text-white  border-gray-100 hover:bg-pink-500 rounded  dark:text-gray-400  dark:hover:bg-gray-700 dark:hover:text-white  dark:border-gray-700">SEVICE</Link>
								</li>
								<li>
									<Link to='/clothes'
